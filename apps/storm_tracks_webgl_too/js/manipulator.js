...
globeManipulator = function(params) {
    ...
    this.enable_auto_rotate = function(val) {
        _auto_rotate = val;
    }
    ...
    function _on_mouse_move(event) {
        ...
        var scaled_distance = ((_distance - _min_distance) / distance_range) * 0.5 + 0.1;
    ...
    function lat_lng_from_mouse_pos(event) {
        ...
        var mouse_x = (x_pos / window.innerWidth) * 2 - 1;
        var mouse_y = -(y_pos / window.innerHeight) * 2 + 1;
